...
When Spine is invoked, load the matching skill under `.claude/skills/`; `/spine-pwf` is the orchestrator and delegates phase detail to `spine-plan`, `spine-implement`, `spine-verify`, and `spine-closeout`. Otherwise work normally.
